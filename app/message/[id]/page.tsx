  ...
  const fetchMessage = async (passwordToUse: string = '') => {
    try {
      ...
      if (response.ok && data.success) {
        ...
        setError(data.error || 'Không thể tải thông điệp');
      }
    } catch (err) {
      setError('Có lỗi xảy ra khi tải thông điệp');
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-pink-50 to-purple-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Đang tải thông điệp...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-50 to-purple-50 flex items-center justify-center">
        ...
        >
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600">Thông điệp này được bảo vệ bằng mật khẩu</p>
          </div>
      ...
      <div className="container mx-auto px-4 max-w-2xl">
        ...
        >
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-800 mb-2">Thông điệp đặc biệt</h1>
